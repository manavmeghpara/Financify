...
class GoalAdapter(private val context: Context, private val goalList: List<GoalEntity>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        var itemView = View.inflate(context, R.layout.goal_adapter_view, null)
